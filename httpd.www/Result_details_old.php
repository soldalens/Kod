...
$stmt = $conn->prepare("
    SELECT ExtroversionPercent, SensingPercent, ThinkingPercent, JudgingPercent, PersonalityType 
    FROM SurveyHeaders 
    WHERE AnswerId = ?
");
...
$descriptionStmt = $conn->prepare("
    SELECT i.InfoTypeId, it.InfoTypeDescr, i.InfoText
    FROM Info AS i
...
<body>
    ...
    <h2 class="text-center">Din personlighetstyp är sannolikt: <?php echo htmlspecialchars($row['PersonalityType']); ?></h2>

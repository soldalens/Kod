...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['invite_multiple'])) {
    ...
    if (empty($senderEmail)) {
        ...
        foreach ($inviteNames as $index => $inviteName) {
            ...
            "&email=" . urlencode($inviteEmail) . "&code=" . urlencode($inviteCode) . "&group=" . urlencode($selectGroup) . "'>Personlig länk</a>";
            ...
            try {
                ...
                $mail->Subject = "Inbjudan till din professionella personlighetsanalys – ProAnalys";
